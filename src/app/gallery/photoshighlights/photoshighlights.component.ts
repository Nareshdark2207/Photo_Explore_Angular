...
@Component({
  selector: 'app-photoshighlights',
  templateUrl: './photoshighlights.component.html',
  styleUrls: ['./photoshighlights.component.css']
})
export class PhotoshighlightsComponent implements OnInit {
